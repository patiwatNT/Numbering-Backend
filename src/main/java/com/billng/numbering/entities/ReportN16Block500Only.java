 ...
 */
@Entity
@Table(name = "REPORT_N_16_BLOCK_500_ONLY")
public class ReportN16Block500Only implements Serializable {
    ...
    public ReportN16Block500Only() {
    }

    public ReportN16Block500Only(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReportN16Block500Only)) {
            return false;
        }
        ReportN16Block500Only other = (ReportN16Block500Only) object;
    ...
    public String toString() {
        return "com.mycompany.genentities.ReportN16Block500Only[ id=" + id + " ]";
    }
