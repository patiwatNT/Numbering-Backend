 ...
 */
@Entity
@Table(name = "NBR_REPORT500")
public class NbrReport500 implements Serializable {
    ...
    public NbrReport500(String blockStart) {
        this.blockStart = blockStart;
    }

    public NbrReport500(String blockStart, int blockId, String blockEnd) {
        this.blockStart = blockStart;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NbrReport500)) {
            return false;
        }
        NbrReport500 other = (NbrReport500) object;
    ...
    public String toString() {
        return "com.mycompany.genentities.NbrReport500[ blockStart=" + blockStart + " ]";
    }
