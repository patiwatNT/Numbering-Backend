 ...
 */
@Entity
@Table(name = "REPORT_N_16_BLOCK_500_INC")
public class ReportN16Block500Inc implements Serializable {
    ...
    public ReportN16Block500Inc() {
    }

    public ReportN16Block500Inc(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReportN16Block500Inc)) {
            return false;
        }
        ReportN16Block500Inc other = (ReportN16Block500Inc) object;
    ...
    public String toString() {
        return "com.mycompany.genentities.ReportN16Block500Inc[ id=" + id + " ]";
    }
