 ...
 */
@Entity
@Table(name = "REPORT_N_16_BLOCK_100_INC")
public class ReportN16Block100Inc implements Serializable {
    ...
    public ReportN16Block100Inc() {
    }

    public ReportN16Block100Inc(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReportN16Block100Inc)) {
            return false;
        }
        ReportN16Block100Inc other = (ReportN16Block100Inc) object;
    ...
    public String toString() {
        return "com.mycompany.genentities.ReportN16Block100Inc[ id=" + id + " ]";
    }
